...
/* Signature hero graphic: an animated land-survey plot diagram —
   a dashed boundary that draws itself in, corner pins, and a
   surveyor-style plot label. Specific to a land/plot business. */
...
/* Secondary signature graphic: an isometric building outline that
   echoes the logo's own 3D "M" roofline, rendered in line art. */
function IsoBuildingGraphic() {
  return (
    <svg
      className={styles.isoSvg}
      viewBox="0 0 300 300"
      xmlns="http://www.w3.org/2000/svg"
    >
      <polygon points="150,20 260,80 260,80 150,140" fill="none" stroke="#141414" strokeWidth="2" />
      <polygon points="150,20 40,80 150,140" fill="none" stroke="#141414" strokeWidth="2" />
      <polygon points="150,140 260,80 260,220 150,280" fill="#9E1B1E" opacity="0.9" />
      <polygon points="150,140 40,80 40,220 150,280" fill="#E2231A" opacity="0.95" />
      <line x1="150" y1="140" x2="150" y2="280" stroke="#141414" strokeWidth="2" />
      <line x1="40" y1="80" x2="40" y2="220" stroke="#141414" strokeWidth="1.5" />
      <line x1="260" y1="80" x2="260" y2="220" stroke="#141414" strokeWidth="1.5" />
      <line x1="150" y1="20" x2="150" y2="140" stroke="#141414" strokeWidth="1.5" />
    </svg>
  );
}
